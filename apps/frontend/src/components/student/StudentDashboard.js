...
function StudentDashboard() {
  ...
  useEffect(() => {
    ...
    setTimeout(() => {
      ...
      infoToast(
        "Welcome back! You have 2 upcoming exams. Check your assignments below.",
        5000,
      );
  ...
  const handleReportIssue = () => {
    ...
    successToast(
      "Issue reported successfully. Our team will respond within 24 hours.",
      4000,
    );
      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="bg-white shadow-sm rounded-lg border border-gray-200 overflow-hidden">
          <div className="px-6 py-4 border-b border-gray-200">
            ...
            <p className="text-sm text-gray-600">
              Click on any assignment for detailed information and navigation
              help
            </p>
          </div>
                    ...
                    <div className="flex-1">
                      <div className="flex items-start space-x-4">
                        ...
                        <div className="flex-1 min-w-0">
                          ...
                          <p className="text-sm text-gray-600">
                            Taught by {assignment.instructor}
                          </p>
                          ...
                          <div className="mt-4 grid grid-cols-1 md:grid-cols-3 gap-4">
                            ...
                            <div className="flex items-center space-x-2">
                              ...
                              <div>
                                ...
                                <div className="text-sm text-gray-600">
                                  {assignment.current_students}/
                                  {assignment.room_capacity} students
                                </div>
                              </div>
                            </div>
                            <div className="flex items-center space-x-2">
            ...
            {assignments.filter(
              ...
              <div className="px-6 py-8 text-center">
                ...
                <p className="text-gray-600">
                  Try adjusting your search terms or check with your instructor.
                </p>
              </div>
            )}
          </div>
        ...
        <div className="mt-8 bg-white rounded-lg border border-gray-200 p-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            <button
              onClick={() =>
                window.open("https://campus-map.university.edu", "_blank")
              }
            ...
            <button
              onClick={() =>
                infoToast(
                  "📧 Support contact: exams@university.edu - Response within 24 hours",
                  5000,
                )
              }
