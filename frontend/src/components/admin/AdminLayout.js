      ...
      <aside className={`${sidebarCollapsed ? 'w-16' : 'w-64'} bg-gray-900 text-white transition-all duration-300 ease-in-out flex flex-col shadow-lg`}>
        ...
        <nav className="flex-1 p-2">
          <ul className="space-y-0.5">
            ...
            <li>
              <Link to="/admin/documentation" className={`flex items-center ${sidebarCollapsed ? 'justify-center' : ''} p-2 text-white hover:bg-gray-700 hover:text-blue-300 hover:scale-105 hover:shadow-lg transform transition-all duration-300 rounded-lg`}>
                <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M12 6.253v13m0-13C10.832 5.477 9.246 5 7.5 5S4.168 5.477 3 6.253v13C4.168 18.477 5.754 18 7.5 18s3.332.477 4.5 1.253m0-13C13.168 5.477 14.754 5 16.5 5c1.746 0 3.332.477 4.5 1.253v13C19.832 18.477 18.246 18 16.5 18c-1.746 0-3.332.477-4.5 1.253"/>
                </svg>
                {!sidebarCollapsed && <span className="ml-2 text-sm">Documentation</span>}
              </Link>
            </li>
            <li>
              <Link to="/admin/notifications" className={`flex items-center ${sidebarCollapsed ? 'justify-center' : ''} p-2 text-white hover:bg-gray-700 hover:text-blue-300 hover:scale-105 hover:shadow-lg transform transition-all duration-300 rounded-lg`}>
                <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <li>
              <Link to="/admin/help-support" className={`flex items-center ${sidebarCollapsed ? 'justify-center' : ''} p-2 text-white hover:bg-gray-700 hover:text-blue-300 hover:scale-105 hover:shadow-lg transform transition-all duration-300 rounded-lg`}>
                <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <li>
              <Link to="/admin/settings" className={`flex items-center ${sidebarCollapsed ? 'justify-center' : ''} p-2 text-white hover:bg-gray-700 hover:text-blue-300 hover:scale-105 hover:shadow-lg transform transition-all duration-300 rounded-lg`}>
                <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
