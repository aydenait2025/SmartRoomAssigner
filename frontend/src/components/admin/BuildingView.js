  ...
  const handleFileSelect = async (e) => {
    ...
    try {
      const response = await axios.post(
        "http://localhost:5000/import-buildings",
        formData,
        {
          headers: {
      ...
      <div className="flex justify-between items-center mb-6">
        <div>
          ...
          <p className="text-gray-600">
            Manage all campus buildings, view details, and import building data
          </p>
        </div>
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-6">
          ...
          <div className="group relative bg-gradient-to-br from-purple-500 to-purple-600 text-white p-4 rounded-lg shadow-md hover:shadow-lg transition-all duration-300 transform hover:-translate-y-0.5 hover:scale-102 cursor-pointer">
            ...
            <div className="relative z-10">
              <div className="text-2xl font-bold mb-1 group-hover:scale-105 transition-transform duration-300">
                {buildings
                  .reduce((sum, b) => sum + b.total_capacity, 0)
                  .toLocaleString()}
              </div>
              <div className="text-xs font-medium opacity-90">
                Total Capacity
        ...
        {buildings.length === 0 ? (
          <div className="p-12 text-center">
            ...
            <p className="text-gray-600 mb-4">
              Click the "Upload Buildings" button to import building data from a
              CSV file.
            </p>
          </div>
        ) : (
      ...
      {buildings.length > 0 && (
        <div className="mt-6 bg-gray-50 p-4 rounded-lg border border-gray-200">
          <p className="text-sm text-gray-600">
            <strong>Note:</strong> Each building is automatically equipped with
            multiple rooms. You can modify room details, capacities, and
            availability through the "Room Management" tab. Use the "Upload
            Buildings" button to import building data from a CSV file.
          </p>
