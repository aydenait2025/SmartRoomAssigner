  ...
  const faqData = [
    {
      ...
      answer:
        'Navigate to Assignments tab, select an exam, and use the "Smart Assign" button for automatic assignment or "Manual Assign" for custom assignments.',
    ...
    },
    {
      ...
      answer:
        'Go to Room Management, use the "Import Rooms" feature to upload a CSV file with building and room data, or add them manually.',
      category: "rooms",
    },
    {
      id: 3,
      ...
      answer:
        'Use the Student Management tab and click "Import Students" to upload a CSV file with student information including names, IDs, and departments.',
      category: "students",
    },
    {
      id: 4,
      ...
      answer:
        "The system will highlight conflicts in red. Go to Assignments tab, review the conflicts, and manually reassign students to available rooms.",
      category: "assignments",
    },
    {
      id: 5,
      ...
      answer:
        "Visit the Reports tab to generate various reports including assignment summaries, room utilization, and student statistics.",
      category: "reports",
    },
    {
      id: 6,
      ...
      answer:
        "Click on Buildings in the sidebar, search for a building by code or name, and click on buildings to see their location on the interactive map.",
      category: "buildings",
    },
  ];
            ...
            <div className="space-y-4">
              <div className="flex items-start space-x-3">
                ...
                <div>
                  ...
                  <p className="text-sm text-gray-600">
                    Start by importing buildings, rooms, and student data using
                    CSV files.
                  </p>
                </div>
              </div>
              <div className="flex items-start space-x-3">
                ...
                <div>
                  ...
                  <p className="text-sm text-gray-600">
                    Create exam schedules in the Course Management section.
                  </p>
                </div>
              </div>
              <div className="flex items-start space-x-3">
                ...
                <div>
                  ...
                  <p className="text-sm text-gray-600">
                    Use Smart Assign for automatic assignment or Manual Assign
                    for custom control.
                  </p>
                </div>
              </div>
              <div className="flex items-start space-x-3">
                ...
                <div>
                  ...
                  <p className="text-sm text-gray-600">
                    Export assignments and generate utilization reports.
                  </p>
                </div>
              </div>
            </div>
          ...
          <div className="bg-white border border-gray-200 rounded-lg p-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div
                ...
                onClick={() => infoToast("Video tutorial would play here")}
              >
